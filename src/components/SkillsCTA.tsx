...
export default function SkillsCTA() {
  return (
    <section id="skills" data-screen-label="Skill library CTA" className="py-20 px-10 bg-surface border-t border-border border-b border-border">
        ...
        <div className="grid grid-cols-[1fr_auto] gap-12 items-center" data-reveal>
          ...
          <div className="flex flex-col items-end gap-5 text-right">
            <p className="text-[15px] text-muted leading-[1.65] max-w-[340px] m-0">
              Browse every skill. MARK selects them automatically — or copy any skill manually.
            </p>
            <a
              href="/skills"
